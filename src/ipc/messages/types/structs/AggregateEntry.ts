...
export class AggregateEntry extends _StructBase {
    ...
    static _leapStruct: valuetype.LeapStruct = new valuetype.LeapStruct("aggregate-entry", [], [new valuetype.Property("id", new valuetype.ValueType("int", [])), new valuetype.Property("name", new valuetype.ValueType("str", [])), new valuetype.Property("path", new valuetype.ValueType("str", [])), new valuetype.Property("self-size", new valuetype.ValueType("int", [])), new valuetype.Property("size", new valuetype.ValueType("int", [])), new valuetype.Property("tail-size", new valuetype.ValueType("int", [])), new valuetype.Property("self-file-count", new valuetype.ValueType("int", [])), new valuetype.Property("file-count", new valuetype.ValueType("int", [])), new valuetype.Property("tail-file-count", new valuetype.ValueType("int", [])), new valuetype.Property("self-dir-count", new valuetype.ValueType("int", [])), new valuetype.Property("dir-count", new valuetype.ValueType("int", [])), new valuetype.Property("tail-dir-count", new valuetype.ValueType("int", [])), new valuetype.Property("is-file", new valuetype.ValueType("bool", [])), new valuetype.Property("parent", new valuetype.ValueType("option", [new valuetype.ValueType("int", [])])), new valuetype.Property("nested", new valuetype.ValueType("list", [new valuetype.ValueType("int", [])]))]);
    id: number;
    name: string;
    path: string;
    selfSize: number;
    ...
    constructor(id: number, name: string, path: string, selfSize: number, size: number, tailSize: number, selfFileCount: number, fileCount: number, tailFileCount: number, selfDirCount: number, dirCount: number, tailDirCount: number, isFile: boolean, parent: number | null, nested: Array<number>, ) {
        super();
        this.id = id;
        this.name = name;
        this.path = path;
    ...
    _verifyAsTypeOrRaise(path: string[], valueType: valuetype.ValueType): void {
        if (valueType.name == AggregateEntry._type) {
            ...
            _ValueBase._verifyValueOrRaise(path.concat(['parent']), this.parent, structType.props[13].propType);
            _ValueBase._verifyValueOrRaise(path.concat(['nested']), this.nested, structType.props[14].propType);
        } else {
    ...
    _toLdm(valueType: valuetype.ValueType): ldm.Value {
        ...
        value.set("parent", _ValueBase._valueToLdm(this.parent, structType.props[13].propType));
        value.set("nested", _ValueBase._valueToLdm(this.nested, structType.props[14].propType));
