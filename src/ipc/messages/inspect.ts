...
export const leapStructsMap = new Map<string, LeapStruct> ([
    ["aggregate-entry", new valuetype.LeapStruct("aggregate-entry", [], [new valuetype.Property("global-id", new valuetype.ValueType("int", [])), new valuetype.Property("local-id", new valuetype.ValueType("int", [])), new valuetype.Property("name", new valuetype.ValueType("str", [])), new valuetype.Property("path", new valuetype.ValueType("str", [])), new valuetype.Property("self-size", new valuetype.ValueType("int", [])), new valuetype.Property("size", new valuetype.ValueType("int", [])), new valuetype.Property("tail-size", new valuetype.ValueType("int", [])), new valuetype.Property("self-file-count", new valuetype.ValueType("int", [])), new valuetype.Property("file-count", new valuetype.ValueType("int", [])), new valuetype.Property("tail-file-count", new valuetype.ValueType("int", [])), new valuetype.Property("self-dir-count", new valuetype.ValueType("int", [])), new valuetype.Property("dir-count", new valuetype.ValueType("int", [])), new valuetype.Property("tail-dir-count", new valuetype.ValueType("int", [])), new valuetype.Property("is-file", new valuetype.ValueType("bool", [])), new valuetype.Property("global-parent", new valuetype.ValueType("option", [new valuetype.ValueType("int", [])])), new valuetype.Property("local-parent", new valuetype.ValueType("option", [new valuetype.ValueType("int", [])])), new valuetype.Property("nested", new valuetype.ValueType("list", [new valuetype.ValueType("int", [])]))])],
    ["scan-progress", new valuetype.LeapStruct("scan-progress", [], [new valuetype.Property("done-count", new valuetype.ValueType("int", []))])],
    ["navigation", new valuetype.LeapStruct("navigation", [], [new valuetype.Property("global-id", new valuetype.ValueType("int", [])), new valuetype.Property("path", new valuetype.ValueType("str", []))])],
