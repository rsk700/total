...
export const leapEnumsMap = new Map<string, LeapEnum> ([
    ["entry-type", new valuetype.LeapEnum("entry-type", [], [new valuetype.Property("directory", new valuetype.ValueType("none", [])), new valuetype.Property("file", new valuetype.ValueType("none", []))])],
...
export const leapVariantsMap = new Map<string, Map<string, LeapVariant>>([
    [
        ...
        new Map<string, LeapVariant>([
            ["directory", new valuetype.LeapVariant("entry-type", new valuetype.Property("directory", new valuetype.ValueType("none", [])), [], [])],
            ["file", new valuetype.LeapVariant("entry-type", new valuetype.Property("file", new valuetype.ValueType("none", [])), [], [])],
        ])
    ],
    [
        "scan-state",
