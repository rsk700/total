...
pub fn get_leap_enums_map() -> HashMap<String, value_type::LeapEnum> {
    [
        ("entry-type".to_owned(), value_type::LeapEnum::new("entry-type".to_owned(), vec![], vec![value_type::Property::new("directory".to_owned(), value_type::ValueType::new("none".to_owned(), vec![])), value_type::Property::new("file".to_owned(), value_type::ValueType::new("none".to_owned(), vec![]))])),
...
pub fn get_leap_variants_map() -> HashMap<String, HashMap<String, value_type::LeapVariant>> {
    [
        (
            "entry-type".to_owned(),
            [
                ("directory".to_owned(), value_type::LeapVariant::new("entry-type".to_owned(), value_type::Property::new("directory".to_owned(), value_type::ValueType::new("none".to_owned(), vec![])), vec![], vec![])),
                ("file".to_owned(), value_type::LeapVariant::new("entry-type".to_owned(), value_type::Property::new("file".to_owned(), value_type::ValueType::new("none".to_owned(), vec![])), vec![], vec![])),
            ].into()
        ),
        (
            "scan-state".to_owned(),
