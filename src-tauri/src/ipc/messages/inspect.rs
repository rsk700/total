...
pub fn get_leap_structs_map() -> HashMap<String, value_type::LeapStruct> {
    [
        ...
        ("navigation".to_owned(), value_type::LeapStruct::new("navigation".to_owned(), vec![], vec![value_type::Property::new("global-id".to_owned(), value_type::ValueType::new("int".to_owned(), vec![])), value_type::Property::new("path".to_owned(), value_type::ValueType::new("str".to_owned(), vec![]))])),
