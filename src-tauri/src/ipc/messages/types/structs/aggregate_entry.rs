...
impl AggregateEntry {
    pub fn new(id: i64, name: String, path: String, self_size: i64, size: i64, self_file_count: i64, tail_size: i64, file_count: i64, self_dir_count: i64, dir_count: i64, is_file: bool, nested: Vec<i64>, parent: Option<i64>, ) -> Self {
        Self {
            id,
            name,
            path,
